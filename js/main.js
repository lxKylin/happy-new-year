! function (t) {
  ...
  var n = i(13),
    ...
    h = function () {
      return {
        ...
        // fireWords: "我的女孩|新的一年|愿你|温馨常伴|万事可期|不熬夜|不失眠|加班少一点|快乐多一点|天天想我|天天爱我|最重要是|年年有我|岁岁有我|爱你",
        fireWords: "偷偷许个愿|希望|今年|陪我的你|明年|还会|在我身边|小手一牵|陪你|今年|明年|年年|以后的|每一年|都能|相伴左右",
        fireOpt: {
          wordInterval: 2e3
        },
        word: {
        ...
        titleWords: "宝贝|祝你|新年快乐|永远开心|永远平安|永远有我",
        titleOpt: {
          y: 20,
          gap: 3,
          size: 60,
  ...
  h.dialogueOpt.interval = a.default.transTime(h.dialogueOpt.interval, 120), h.dialogueOpt.speed = a.default.transTime(h.dialogueOpt.speed, 18), h.sunset = a.default.transTime(h.sunset, 600), h.fireworkInterval[0] = a.default.transTime(h.fireworkInterval[0]), h.fireworkInterval[1] = a.default.transTime(h.fireworkInterval[1]), h.fireOpt.wordInterval = a.default.transTime(h.fireOpt.wordInterval, 180), h.fireOpt.denseTime = a.default.transTime(h.fireOpt.denseTime, 600), h.titleOpt.delay = a.default.transTime(h.titleOpt.delay, 240), h.titleOpt.e = a.default.transTime(h.titleOpt.e, 240), (0, o.default)(h.width, h.height, h.canvases), e.default = h
}, function (t, e, i) {
  "use strict";
    ...
    d = function (t) {
      function e() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          y = void 0 === p ? .8 : p;
        n(this, e);
        var v = o(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, {
          x: i,
          y: r,
          minSize: a,
          maxSize: u,
    ...
    h = function () {
      function t() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          c = e.opacity,
          d = void 0 === c ? 1 : c;
        n(this, t), this.size = f || u.default.random(s, h), this.x = i || u.default.random(0, a.default.width - this.size), this.y = r || -this.size, this.opacity = d
      }
      return o(t, [{
        key: "outOfBounds",
        value: function () {
  ...
  ! function () {
    ...
    window.onload = function () {
      a.default.load(o.default).then(function (e) {
        document.querySelector("#loadingText").style.display = "none";
        var i = document.querySelector("#loadingBtn");
        i.style.display = "block", i.addEventListener("click", function () {
          document.querySelector("#loading").style.display = "none", new u.default(t(e))
        })
      }).catch(function (t) {
        console.log(t)
      })
  ...
  var s = function () {
    ...
    x = function () {
      function t(e) {
        o(this, t), this.imgs = e, this.initProperty(), this.initAudio(), this.init()
      }
      return s(t, [{
        key: "initAudio",
        value: function () {
          var t = new Audio;
          t.src = i(18), t.loop = !0, t.play(), t.volume = .5, document.querySelector("#music").onclick = function () {
        ...
        value: function () {
          ...
          }), this.fallDots = [], this.fallType = l.default.fallType, this.time = 0, this.status = l.default.step, this.dialogueOpt = h.default.extend({}, l.default.dialogueOpt), this.dialogue = l.default.dialogue.shift(), this.sunsetTime = l.default.sunset, this.skyColor = {
            hue: 210,
            lightness: 0
        ...
        value: function (t) {
          switch (t) {
            ...
            case 2:
              ...
              break;
            case 3:
              this.fireOpt = null, this.fireWords = null, ++this.status;
              break;
            case 4:
        ...
        key: "init",
        value: function () {
          this.drawBg(this.bgCtx, this.imgs.bg), this.shapeMaker = new w.default(this.width, this.height), this.test(), this.loop()
        }
      }, {
        key: "test",
        value: function () {}
        ...
        value: function () {
          switch (this.fallCtx.clearRect(0, 0, this.width, this.height), this.fallType) {
            case "snow":
              this.time % l.default.snowInterval == 0 && this.fallDots.push(new c.default(l.default.snow));
              break;
            case "heart":
              this.time % l.default.heartInterval == 0 && this.fallDots.push(new p.default(l.default.heart));
              break;
            case "mix":
              this.time % l.default.snowInterval == 0 && this.fallDots.push(new c.default(l.default.snow)), this.time % l.default.heartInterval == 0 && this.fallDots.push(new p.default(l.default.heart))
          }
        ...
        value: function () {
          ...
          if (t.clearRect(0, 0, l.default.width, l.default.height), t.fillStyle = this.dialogueOpt["color" + this.dialogue.type] || this.dialogueOpt.color1, t.font = this.dialogueOpt["font" + this.dialogue.type] || this.dialogueOpt.font1, this.dialogue.current = this.dialogue.current || 0, --this.dialogueOpt.speed <= 0 && (this.dialogueOpt.speed = l.default.dialogueOpt.speed, ++this.dialogue.current), t.fillText(this.dialogue.name + "：" + this.dialogue.txt.slice(0, this.dialogue.current), 20, 30), this.dialogue.current >= this.dialogue.txt.length && --this.dialogueOpt.interval <= 0) {
        ...
        key: "controlFire",
        value: function () {
          --this.fireOpt.time, 0 == this.fireOpt.time && this.createDenseFire(), this.fireOpt.time <= -180 && !this.fireOpt.end && this.showFireworkWords(), -60 == this.fireOpt.time && this.fireOpt.end && this.fireworks.push(new v.default({
            x: l.default.width / 2,
        ...
        value: function () {
          for (var t = this, e = 0; e < 10; e++) setTimeout(function () {
            t.fireworks.push(new v.default(l.default.fireworks))
          }, 100 * e)
        }
      }, {
        key: "renderFireworks",
        ...
        key: "createFireworks",
        value: function () {
          --this.fireworkTime <= 0 && (this.fireworks.push(new v.default(l.default.fireworks)), this.fireworkTime = 0 | h.default.random.apply(h.default, n(l.default.fireworkInterval)))
        }
      }, {
        key: "renderTitle",
        value: function () {
        ...
        value: function () {
          ...
          if (!this.titleOpt.start) {
            ...
            this.titleDots = [], this.titleOpt.start = !0, this.titleOpt.time = l.default.titleOpt.e + l.default.titleOpt.delay, l.default.titleOpt.y += l.default.titleOpt.distance;
            this.getDotsPostion(this.titleWords.shift()).forEach(function (e) {
              var i = {
                color: l.default.titleOpt.color,
                x: e.x,
                y: e.y,
              ...
              t.titleDots.push(new b.default(i))
            }), this.fallType = "mix"
          }
        }
      }, {
        ...
        value: function (t, e) {
          ...
          var o = r.length,
            s = 3 === this.status ? l.default.word.size : l.default.titleOpt.size,
            a = 3 == this.status ? l.default.word.y : l.default.titleOpt.y,
            u = [];
          return r.forEach(function (t, r) {
            var h = void 0;
            h = o % 2 == 0 ? l.default.width / 2 + (r - o / 2) * s + .5 * s : l.default.width / 2 + (r - Math.floor(o / 2)) * s, i.shapeMaker.write({
              txt: t,
              x: h,
              y: a,
              size: s,
            ...
            var f = i.shapeMaker.getDots({
              gap: 3 == i.status ? l.default.word.gap : l.default.titleOpt.gap
            });
            u.push.apply(u, n(f));
            var c = {};
            e && i.fireworks.push(new v.default({
              wait: 30,
              radius: 2,
              x: h,
              yEnd: a,
        ...
        value: function (t, e) {
          var i = e.width,
            ...
            l = void 0,
            u = void 0;
          n >= o ? (a = 0, u = r, s = (n - o) * i / 2, l = r * o) : n < o && (s = 0, l = i, a = (r - i / o) / 2, u = i / o), t.drawImage(e, s, a, l, u, 0, 0, this.width, this.height)
        }
      }]), t
    }();
  e.default = x
    ...
    v = function () {
      function t() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          P = e.prtOption,
          S = void 0 === P ? {} : P;
        if (o(this, t), this.x = i || h.default.random(l.default.width / 8, 7 * l.default.width / 8), this.y = s, this.xEnd = a || this.x, this.yEnd = u || h.default.random(l.default.height / 8, 3 * l.default.height / 8), this.size = c, this.opacity = b, this.velocity = -Math.abs(w), this.wait = k || h.default.random(30, 60), this.radius = h.default.random.apply(h.default, n(v)), this.GRAVITY = y, this.hue = 360 * Math.random() | 0, this.color = _ || "hsla(" + this.hue + ",80%,60%,1)", this.status = 1, z) {
          this.type = "words";
          var T = {
            xStart: this.xEnd,
            yStart: this.yEnd
        ...
        } else this.count = 0 | h.default.random.apply(h.default, n(O)), this.particles = [], this.createParticles(), this.type = "normal"
      }
      return s(t, [{
        key: "createParticles",
        value: function () {
          for (var t = 0; t < this.count; ++t) this.particles.push(new c.default({
            x: this.xEnd,
            y: this.yEnd,
            radius: this.radius
          }))
  ...
  var s = function () {
    ...
    u = function (t) {
      function e(t) {
        ...
        return c.dx = (i - h) / 80, c.dy = (o - f) / 80, c.xStart = h, c.yStart = f, c
      }
      return o(e, t), s(e, [{
        key: "go",
        value: function () {
      ...
      return n(t, [{
        ...
        value: function () {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            o = void 0 === n ? "Arial" : n,
            s = t.x,
            a = void 0 === s ? this.canvas.width / 2 : s,
            l = t.y,
            u = void 0 === l ? 100 : l;
          this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height), this.ctx.font = "bold " + r + "px " + o, this.ctx.fillText(e, a, u), this.x = a, this.y = u, this.size = r, this.count = e.length
        }
      }, {
        key: "getPosition",
        value: function () {
        ...
        key: "getDots",
        value: function () {
          for (var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = t.mini, i = void 0 === e ? 1 : e, r = t.gap, n = void 0 === r ? 5 : r, o = this.y - this.size / 2, s = this.canvas.width, a = this.size, l = this.ctx.getImageData(0, o, s, a).data, u = [], h = 0, f = o, c = 0, d = 0, p = l.length; d <= p; d += 4 * n) l[d + 3] > 0 && ++c % i == 0 && u.push({
            x: h,
            y: f
          }), (h += n) >= 0 + s && (f += n, d += 4 * (n - 1) * s - 4 * (h - 0 - s), h = 0);
          return u
        }
      }]), t
    }();
  ...
  var s = function () {
    ...
    u = function (t) {
      function e(t) {
        ...
        return d.yEnd = a, d.xEnd = s, d.e = c, d.dx = (d.xEnd - d.x) / d.e, d.dy = (d.yEnd - d.y) / d.e, d.status = 1, d
      }
      return o(e, t), s(e, [{
        key: "go",
        value: function () {
